...
def main(gpus: Optional[Union[int, str, List[int]]], accelerator: Optional[str], amp_backend: str, accumulate_grad_batches: Union[int, Dict[int, int], List[list]]learning_rate: float, num_warmup_steps: int, num_epochs: int, weight_decay: float) -> None:
